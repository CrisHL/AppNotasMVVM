...
import mx.edu.dsi_code.notasmvvm.components.NoteButton
import mx.edu.dsi_code.notasmvvm.components.NoteIputText
    ...
    Column(modifier=Modifier.padding(6.dp)) {
        ...
        Column (modifier = Modifier.fillMaxWidth(),
            ...
            NoteIputText(
                ...
                text = title, label = "Titulo", onTextChange ={
                    if(it.all { char ->
...
{
    /*1.- mando llamar al componente*/
    /*2.-Pasamos la lista del coomponente*/
    NoteScreen(notas= NotesDataSource().loadNotes(), onAddNote = {}, onRemoveNote = {})
}
@Composable
